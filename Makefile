# This Makefile is for the Odroid::WiringPi extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Odroid/WiringPi.pm]
#     AUTHOR => [q[jkline <gizmomathboy@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     DEFINE => q[]
#     INC => q[-I/usr/local/include]
#     LIBS => [q[-lwiringPi -lwiringPiDev -lpthread]]
#     NAME => q[Odroid::WiringPi]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Odroid/WiringPi.pm]
...
MAKE = make
FULLEXT = Odroid/WiringPi
BASEEXT = WiringPi
PARENT_NAME = Odroid
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Odroid/WiringPi.pm
...
XS_FILES = WiringPi.xs
C_FILES  = WiringPi.c
O_FILES  = WiringPi.o
H_FILES  = ppport.h
MAN1PODS = 
MAN3PODS = lib/Odroid/WiringPi.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Odroid
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Odroid
...
TO_INST_PM = lib/Odroid/WiringPi.pm

PM_TO_BLIB = lib/Odroid/WiringPi.pm \
	blib/lib/Odroid/WiringPi.pm
...
DISTNAME = Odroid-WiringPi
DISTVNAME = Odroid-WiringPi-0.01.02
...
# Odroid::WiringPi might depend on some other libraries:
# See ExtUtils::Liblist for details
#
EXTRALIBS = -lwiringPi -lwiringPiDev
LDLOADLIBS = -lwiringPi -lwiringPiDev -lpthread
BSLOADLIBS = 
...
manifypods : pure_all  \
	lib/Odroid/WiringPi.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Odroid/WiringPi.pm $(INST_MAN3DIR)/Odroid::WiringPi.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''gizmomathboy <gizmomathboy@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Odroid-WiringPi' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "gizmomathboy <gizmomathboy@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Odroid-WiringPi",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>gizmomathboy &lt;gizmomathboy@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="arm-linux-gnueabihf-thread-multi-64int-5.18" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Odroid/WiringPi.pm blib/lib/Odroid/WiringPi.pm 
